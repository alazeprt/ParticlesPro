...
public class Three_Dimensional {
    ...
    public void handle(Location location, String[] args) {
        if(args.length == 2 && args[1].equals("help")) {
            ...
            listener.sendMessage(location, "§e/particlex 3 soild_cube <边长> <水平角度>  §a- 在自己的中心生成一个实心正方体");
            listener.sendMessage(location, "§b/particlex 3 hollow_cube <边长> <水平角度>  §a- 在自己的中心生成一个空心正方体");
            listener.sendMessage(location, "§b/particlex 3 sphere <半径> <水平角度>  §a- 在自己的中心生成一个球体");
            listener.sendMessage(location, "§b/particlex 3 cylinder <半径> <高>  §a- 在自己的中心生成一个圆柱体");
            listener.sendMessage(location, "§b/particlex 3 spiral <长度> <水平角度> <垂直角度> <左右间隔> <每一次螺旋的长度>  §a- 在自己的中心生成一个螺旋体");
